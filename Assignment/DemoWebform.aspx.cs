...
public partial class DemoWebform : System.Web.UI.Page
{
  ...
  private void drawCanvas()
  {
    ...
    {
      DemoRectangle rect = new DemoRectangle(d["X"], d["Y"], d["width"], d["length"]);
    ...
    DemoRectangle myRect1 = new DemoRectangle(30, 130, 10, 100);
    myRect1.DrawRectangle(myGraphics, myPen);

    DemoRectangle myRect2 = new DemoRectangle(40, 200, 200, 30);
